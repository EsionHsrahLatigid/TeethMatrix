...
void ParameterGridEditor::syncAuditionControls()
{
    ...
    static_cast<ehl::ui::CommandButton*> (auditionButton.get())->setSelected (teethmatrixProcessor->isAuditionEnabled());
    static_cast<ehl::ui::CommandButton*> (auditionTypeButton.get())->setSelected (teethmatrixProcessor->getAuditionType() != 0);
#endif
}
