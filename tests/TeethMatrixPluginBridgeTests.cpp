...
public:
    ...
    teethmatrix::plugin::TeethMatrixPlugin plugin;
...
void testParameterResponse()
{
    ...
    softParameters[1]->setValue (0.0f);
    softParameters[2]->setValue (0.0f);
    softParameters[5]->setValue (0.0f);
    const auto softPeak = soft.processConstantBlocks (0.5f, 8);
    ...
    const auto hardPeak = hard.processConstantBlocks (0.5f, 8);
...
int main()
{
    ...
    std::cout << "TeethMatrixPluginBridgeTests passed\n";
    return 0;
}
